...
#TODO : No raw values : only named variable to help future changes 

##moved align_primer from this file to PrimerAlignment.py
...
def align_primer_random_scores(seq_length=500, primer_length=26, iterations=1000, seed=0, print_scores=True):
        ...
        for it in range(iterations):
            ...
            scores[it] = PrimerAllAlignments.align_primer(seq, primer).primer_score
