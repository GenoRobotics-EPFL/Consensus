...
if __name__ == '__main__':
    ...
    BestSequences.save("assets/best-sequences/BestSequences_rbcL_Qiagen_tomato_5000.pickle") # save for later use (without having to rerun run_primer_alignments for example)
    BestSequences = MultiSequence("assets/best-sequences/BestSequences_rbcL_Qiagen_tomato_5000.pickle") # the saved MultiSequence() can be reloaded like this
    BestSequences.write_to_fastq("assets/best-sequences/BestSequences_rbcL_Qiagen_tomato_5000.fastq")
